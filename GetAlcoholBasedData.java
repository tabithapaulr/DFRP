...
@WebServlet(name = "getAlcoholBasedData", urlPatterns = {"/getAlcoholBasedData"})
public class GetAlcoholBasedData extends HttpServlet {
        ...
        try {
            ...
            if (ctype.equals("Alcohol")) {
                ...
                if (rs.next()) {
                    ...
                    double y[] = {data1, data2, data3, data4, data5, data6, data7, data8, data9, data10};

                    LinearRegression lr = new LinearRegression(x, y);
                    json11.put("name", "2018");
                    json11.put("y", lr.predict(11));
                    
                    PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Alcohol' and State='"+state+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,PYear,Accident,State) values('Alcohol','2018','"+lr.predict(11)+"','"+state+"') ");
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        double y[] = {data2, data3, data4, data5, data6, data7, data8, data9, data10};
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='Fog' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','Fog','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs1.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='Cloud' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','Cloud','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs2.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='HeavyRain' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','HeavyRain','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs3.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='LightRain' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','LightRain','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs4.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='Snow' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','Snow','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs5.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='Hot' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','Hot','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs6.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Climate' and SubCategory='Cold' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `climatebasedrecords` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Climate','Cold','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Location' and SubCategory='NearSchool' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Location','NearSchool','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs1.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Location' and SubCategory='NearFactory' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Location','NearFactory','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs2.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Location' and SubCategory='NearHospital' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Location','NearHospital','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs3.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Location' and SubCategory='NearBusStop' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Location','NearBusStop','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs4.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Location' and SubCategory='NearBazaar' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Location','NearBazaar','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='VehicleDefect' and SubCategory='DefectiveBrakes' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('VehicleDefect','DefectiveBrakes','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs1.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='VehicleDefect' and SubCategory='Punctured' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('VehicleDefect','Punctured','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs2.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='VehicleDefect' and SubCategory='BaldTyres' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('VehicleDefect','BaldTyres','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs3.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='VehicleDefect' and SubCategory='Others' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('VehicleDefect','Others','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Junction' and SubCategory='TJunction' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Junction','TJunction','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs1.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Junction' and SubCategory='YJunction' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Junction','YJunction','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs2.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Junction' and SubCategory='FourArm' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Junction','FourArm','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs3.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Junction' and SubCategory='Round' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Junction','Round','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
                    ...
                    if (rs4.next()) {
                        ...
                        PreparedStatement psss1 = con.prepareStatement(" select * from predictedresult where Category='Junction' and SubCategory='RailCross' and State='"+state+"' and Accident='"+lr.predict(10)+"' and PYear=(SELECT (SELECT DISTINCT `Year` FROM `locationbased` ORDER BY `Year` DESC LIMIT 1)+1 AS `Year`) ");
                    ResultSet rsss1 = psss1.executeQuery();
                    if(rsss1.next())
                    { 
                    }
                    ...
                    {
                        PreparedStatement psss2 = con.prepareStatement(" insert into predictedresult(Category,SubCategory,PYear,Accident,State) values('Junction','RailCross','2018','"+lr.predict(10)+"','"+state+"') ");
                        int k = psss2.executeUpdate();
                        if(k > 0)
                        {
                        }
